...
export const AppBar = () => {
    ...
    return <div className="flex justify-between px-28 p-8 bg-[#f5f5f5] mb-6">
        ...
        <div className="flex">
            <div onClick={() => router.push('/')} className={`flex cursor-pointer items-center justify-between font-bold border-2 rounded-md p-2 min-w-20 text-black mr-4`}><HomeIcon /> <h1 className="ml-3">Home</h1></div>
            ...
            <div className={`${session?.data?.user ? 'block' : 'hidden'}`}> <button onClick={async () => {
                try {
